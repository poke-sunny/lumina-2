  ...
  return (
    <div className="glass h-[600px] flex flex-col rounded-3xl overflow-hidden">
      <div className="p-6 border-b border-zinc-900 flex items-center gap-3">
        ...
        <span className="font-bold text-sm tracking-tight">LUMINA AI v1.0.4</span>
      </div>
      ...
      <form onSubmit={handleSubmit} className="p-6 pt-0">
        <div className="relative">
          <input
            ...
            className="w-full bg-zinc-900/50 border border-zinc-800 rounded-2xl py-4 pl-6 pr-14 focus:outline-none focus:border-accent/50 transition-all text-sm"
          />
