      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-8">
          <div className="glass rounded-[2rem] p-10 relative overflow-hidden group">
            ...
            <div className="space-y-6 max-w-lg">
              <h2 className="text-3xl font-bold">Southampton Waterfront Development</h2>
        ...
        <div className="space-y-8">
          ...
          <div className="glass p-8 rounded-3xl space-y-6">
            <h3 className="font-bold flex items-center gap-2"><ShieldCheck className="text-accent" /> Security Protocol</h3>
